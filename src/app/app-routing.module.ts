import { UserInfoModule } from './pages/admin/user-info/user-info.module';
...
const routes: Routes = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        loadChildren : () => import('@pages/admin/social/social.module').then(
          (m) => m.SocialModule
        )
      },
      {
        path:ROUTER_UTILS.posts.root,
        loadChildren : () => import('@pages/admin/posts/posts.module').then(
          (m) => m.PostsModule
        )
      },
      {
